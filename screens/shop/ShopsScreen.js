...
const ShopsScreen = props => {
  ...
  useEffect(() => {
    ...
    //     const response = await axios.post('http://example.com/getShops.php', { country: country }, { signal: controller.signal });
    ...
    const myTimeout = setTimeout(() => {
      const shopsDataFilteredByCountry = shopsDataInDatabase.filter(shopData => shopData.country === country);
