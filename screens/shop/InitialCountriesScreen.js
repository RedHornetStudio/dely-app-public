...
import InitialCountriesScreenListHeaderComponent from '../../components/InitialCountrieScreen/InitialCountriesScreenListHeaderComponent';

const InitialCountriesScreen = props => {
  console.log('----Initial Countries Screen rerendered----');
  ...
  const renderItem = useCallback(itemData => {
    return (
      <CountryItem id={itemData.item.id} appText={appText} index={itemData.index} navigation={props.navigation} firstRender={firstRender} initial={true} />
    );
  ...
  return (
    <View style={styles.screen}>
      ...
      <CustomSafeAreaFlatListWindow
        ...
        ListHeaderComponent={
          <InitialCountriesScreenListHeaderComponent
            appText={appText}
            inputText={inputText}
...
const styles = StyleSheet.create({
  ...
  customSafeAreaFlatListWindowContentContainerStyle: {
    ...
    paddingBottom: values.windowBottomPadding,
  },
  // ----Languages List----
  countryContainer: {
    marginTop: values.topMarginScecondary,
  },
  bottomLine: {
    marginTop: values.topMarginScecondary,
  },
...
export default InitialCountriesScreen;