...
import { StyleSheet, FlatList, useWindowDimensions, Platform } from 'react-native';
import { useSafeAreaInsets } from 'react-native-safe-area-context';

import { findStyleProp } from '../shared/sharedFunctions';

const CustomSafeAreaFlatListWindow = forwardRef((props, ref) => {
    ...
    <FlatList
      ...
      contentContainerStyle={[
        props.contentContainerStyle,
        {
          ...
          paddingTop: paddingTopPlusInsetsTop,
          paddingBottom: paddingBottomPlusInsetBottom
        }
      ]}
    />
  );
...
export default CustomSafeAreaFlatListWindow;